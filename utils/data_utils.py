...
def get_channels(x, sat_bands):
    b = ['IR_016', 'IR_039', 'IR_087', 'IR_097', 'IR_108', 'IR_120', 'IR_134', 'VIS006', 'VIS008', 'WV_062', 'WV_073']
    band_indices = {band: idx for idx, band in enumerate(b)}
    
    # Select channels based on sat_bands
    selected_channels_idx = [band_indices[band] for band in sat_bands]
    selected_channels_data = x[selected_channels_idx]
    
    return selected_channels_data
    
def crop_numpy(x, crop, padding=None):
    """crop numpy array
