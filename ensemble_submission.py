...
def train(params, gpus, mode, checkpoint_path, model="UNetModel"): 
    ...
    ica_dict={0:[checkpoints_dict["boxi_0015"][2019], checkpoints_dict["boxi_0034"][2019],checkpoints_dict["boxi_0076"][2019],checkpoints_dict["boxi_0076"][2020], checkpoints_dict["roxi_0004"][2019], checkpoints_dict["roxi_0004"][2020],checkpoints_dict["roxi_0006"][2019], checkpoints_dict["roxi_0007"][2019]],
              1: [checkpoints_dict["boxi_0015"][2020], checkpoints_dict["boxi_0034"][2020], checkpoints_dict["roxi_0005"][2019],checkpoints_dict["roxi_0005"][2020], checkpoints_dict["roxi_0006"][2020],checkpoints_dict["roxi_0007"][2020]] }
    ...
    region = params["predict"]["region_to_predict"]
    year = params["predict"]["year_to_predict"]
    
    # Accessing the checkpoint paths based on the specified region and year
    checkpoint_paths = ica_mapping[region][year]
    
    # Loading models using the updated checkpoint paths
    models = [load_model(UNetModel, params, path) for path in checkpoint_paths]
