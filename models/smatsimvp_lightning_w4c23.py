...
#models
from models.SmaAt_SimVP import SmaAt_UNet as Base_UNET3D # 3_3_2 model selection
...
class UNet_Lightning(L.LightningModule):
    def __init__(self, UNet_params: dict, params: dict,
        ...
        self.model = Base_UNET3D(in_channels=self.in_channels, n_classes = self.out_channels)
    ...
    def training_step(self, batch, batch_idx):
        ...
        y_hat = upsample(y_hat) if self.params.get('size_target_center') != 252 else y_hat
